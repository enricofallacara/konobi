...
\fcolorbox{black}{yellow!70!black!40}{\includegraphics[width=0.5\textwidth]{img/Board.png}}
...
\end{frame}
  ...
  \begin{frame} {Rules Cont.}
    ...
    \fcolorbox{black}{yellow!70!black!40}{\includegraphics[width=0.5\textwidth]{img/validpositionrule.png}}\pause
    \hfill
