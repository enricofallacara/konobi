...
%\section{Introduction and rules}
  ...
  \begin{frame}{Building Blocks}
    ...
    \begin{centering}
     ...
     \fcolorbox{black}{yellow!70!black!40}{\includegraphics[width=0.75\textwidth]{/Users/federicopigozzi/IdeaProjects/konobi/presentation/img/TDD.png}}
     ...
     {\includegraphics[width=0.45\textwidth]{/Users/federicopigozzi/IdeaProjects/konobi/presentation/img/singleresponsibilityprinciple.jpg}}
     \fcolorbox{black}{yellow!70!black!40}  	  {\includegraphics[width=0.5\textwidth]{/Users/federicopigozzi/IdeaProjects/konobi/presentation/img/Board.png}}
     ...
     {\includegraphics[width=0.5\textwidth]{/Users/federicopigozzi/IdeaProjects/konobi/presentation/img/validpositionrule.png}}
        \fcolorbox{black}{yellow!70!black!40}\pause
     {\includegraphics[width=0.45\textwidth]{/Users/federicopigozzi/IdeaProjects/konobi/presentation/img/openclosedprinciple.jpeg}}
     \fcolorbox{black}{yellow!70!black!40}\pause
